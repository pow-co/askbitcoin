              ...
              <Grid item sm={6}>
                <LayoutImageWrapper>
                  <Image
                    ...
                    height="100%"
                  />
                  <LayoutImage src={imgLayout2} alt="Ask Bitcoin" style={{ animationDelay: '1.5s' }} />
                </LayoutImageWrapper>
              </Grid>
            </Grid>
          </Grid>
              ...
              <Grid item sm={6}>
                <LayoutImageWrapper>
                  <Image
                    ...
                    height="100%"
                  />
                  <LayoutImage src={imgLayout3} alt="Ask Bitcoin" style={{ animationDelay: '3s' }} />
                </LayoutImageWrapper>
              </Grid>
              <Grid item sm={6}>
                <LayoutContent
