  ...
  return (
    <div className='py-6 xl:p-6 items-center bg-gray-200 dark:bg-gray-800 w-full h-full flex flex-col'>
        ...
        {authenticated && <Link href="/compose">
            <button 
                className=' w-full hidden xl:flex text-sm leading-4 text-white font-semibold w-fit mt-12 mb-6 border-none rounded-md bg-gradient-to-tr from-blue-400 to-blue-500 cursor-pointer items-center text-center justify-center py-2 px-5 transition duration-500 transform hover:-translate-y-1'
            >
