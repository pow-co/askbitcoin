                ...
                >
                  <List
                    ...
                    sx={{
                      ...
                      '& .MuiListItem-root.Mui-selected': {
                        ...
                        '& .MuiChip-root': {
                          color: theme.palette.mode === 'dark' ? theme.palette.primary.main : theme.palette.secondary.light,
                  ...
                  >
                    <ListItemButton selected={filter === 'all'} onClick={() => handleFilter('all')}>
                      ...
                      {unreadCounts && unreadCounts.all !== 0 && <Chip label={unreadCounts.all} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'inbox'} onClick={() => handleFilter('inbox')}>
                      ...
                      {unreadCounts && unreadCounts.inbox !== 0 && <Chip label={unreadCounts.inbox} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'sent'} onClick={() => handleFilter('sent')}>
                      ...
                      {unreadCounts && unreadCounts.sent !== 0 && <Chip label={unreadCounts.sent} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'draft'} onClick={() => handleFilter('draft')}>
                      ...
                      {unreadCounts && unreadCounts.draft !== 0 && <Chip label={unreadCounts.draft} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'spam'} onClick={() => handleFilter('spam')}>
                      ...
                      {unreadCounts && unreadCounts.spam !== 0 && <Chip label={unreadCounts.spam} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'trash'} onClick={() => handleFilter('trash')}>
                      ...
                      {unreadCounts && unreadCounts.trash !== 0 && <Chip label={unreadCounts.trash} size="small" />}
                    </ListItemButton>
                    <Divider />
                    ...
                    <ListItemButton selected={filter === 'starred'} onClick={() => handleFilter('starred')}>
                      ...
                      {unreadCounts && unreadCounts.starred !== 0 && <Chip label={unreadCounts.starred} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'important'} onClick={() => handleFilter('important')}>
                      ...
                      {unreadCounts && unreadCounts.important !== 0 && <Chip label={unreadCounts.important} size="small" />}
                    </ListItemButton>
                    <Divider />
                    ...
                    <ListItemButton selected={filter === 'promotions'} onClick={() => handleFilter('promotions')}>
                      ...
                      {unreadCounts && unreadCounts.promotions !== 0 && <Chip label={unreadCounts.promotions} size="small" />}
                    </ListItemButton>
                    <ListItemButton selected={filter === 'forums'} onClick={() => handleFilter('forums')}>
                      ...
                      {unreadCounts && unreadCounts.forums !== 0 && <Chip label={unreadCounts.forums} size="small" />}
                    </ListItemButton>
                  </List>
                </PerfectScrollbar>
              </Grid>
